...
"""Initial setup script for Oscar. Run it on the device where Oscar will be running.
   ...
   Created by Dan Slimmon
   Remixed by AJ Cordeiro 
...
print "*************************************************************************************"
print
print "ATTENTION: This script should be run with root privileges from the /var/lib/oscar folder."
print "It is currently tested for use with Raspbian and its variants."
print "Before running this script, it is highly recommend you perform your apt-get updates and upgrades."
print 
...
######################################## Digit-Eyes
print "You need to setup a few accounts with some external services to use Oscar. First of all,"
print "go to"
print
...
if communication_method == 'email':
    ...
    print
    print "Please note that the account sending the email must not require two-factor"
